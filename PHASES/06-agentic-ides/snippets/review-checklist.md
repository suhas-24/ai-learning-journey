...
Use this checklist after an agent finishes work. The point is not to hunt for style nits. The point is to ask, in simple terms, "Did the agent stay safe, truthful, and useful?"

Here, `scope` means the boundary of the task.
