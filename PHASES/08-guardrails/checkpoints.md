...
- I can write a simple policy tier table for low, medium, high, and critical actions.
- I can decide which actions require approval and why.
- I can define what audit fields are required for a real approval record.
- I can describe how sandboxing changes blast radius.
